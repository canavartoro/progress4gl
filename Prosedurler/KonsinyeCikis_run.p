...
DO TRANSACTION ON ERROR UNDO, RETURN ERROR:
    ...
    FOR EACH xdetay_table BREAK BY xdetay_table.sira ON ERROR UNDO, RETURN ERROR:                
        ...
        IF FIRST-OF(xdetay_table.sira) THEN DO:
        ...
        END.
         ...
         FIND stok_kart WHERE stok_kart.firma_kod = firma-kod
                          AND stok_kart.stok_kod  = xdetay_table.stok_kod NO-LOCK NO-ERROR.

         IF NOT AVAILABLE stok_kart THEN DO:
             MESSAGE "Stok karti bulunamadi " xdetay_table.stok_kod
                 VIEW-AS ALERT-BOX INFO BUTTONS OK.
             RETURN ERROR.
         END.
         ...
         ASSIGN kon_detay.firma_kod     = firma-kod  
                ...
                kon_detay.dbirim        = xdetay_table.Birim
                kon_detay.depo_kod      = kon_master.depo_kod
                kon_detay.diger_depo    = kon_master.diger_depo
                kon_detay.dmiktar       = xdetay_table.hareket_miktar
                kon_detay.hareket_miktar= xdetay_table.hareket_miktar.         
