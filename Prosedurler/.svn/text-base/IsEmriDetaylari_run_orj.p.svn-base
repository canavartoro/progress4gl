...
DEFINE INPUT PARAMETER xEmir AS CHARACTER NO-UNDO.
DEFINE INPUT PARAMETER xKod AS CHARACTER NO-UNDO.
DEFINE INPUT PARAMETER xAd AS CHARACTER NO-UNDO.
DEFINE INPUT PARAMETER xistkod AS CHARACTER NO-UNDO.
DEFINE INPUT PARAMETER xoprkod AS CHARACTER NO-UNDO.
DEFINE INPUT PARAMETER xFason AS LOGICAL NO-UNDO.
DEFINE INPUT PARAMETER xsirano AS INTEGER NO-UNDO INITIAL 0.

DEFINE INPUT PARAMETER Firma AS CHARACTER NO-UNDO INITIAL "".
DEFINE INPUT PARAMETER Limit AS INTEGER NO-UNDO INITIAL 100.
DEFINE VARIABLE Row_Limit AS INTEGER NO-UNDO INITIAL 0.
DEFINE VARIABLE UretilenMiktar AS INTEGER NO-UNDO INITIAL 0.
DEFINE VARIABLE receteId AS INTEGER NO-UNDO INITIAL 0.
...
FOR EACH erp_master WHERE erp_master.firma_kod = Firma AND
    ...
    (erp_master.stok_kod MATCHES "*" + xKod + "*" OR xKod EQ "") NO-LOCK,
